...
class Blockchain:
   ...
   def proof_of_work(self, previous_proof):
       new_proof = 1 # miners proof submitted
       check_proof = False # status of proof of work
...
@app.route('/mine_blockchain', methods=['GET'])
...
def mine_blockchain():
   ...
   response = {'message': 'Blockchain Mined!',
               'index': block['index'],
...
# after run this code, you need to fallow adress and mention "/mine_blockchain"
